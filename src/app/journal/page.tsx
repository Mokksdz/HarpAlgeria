...
export default async function JournalPage({ searchParams }: JournalPageProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-harp-cream/50 to-white">
      {/* Hero Section */}
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center relative z-10">
            ...
            <p className="text-lg md:text-xl text-gray-500 leading-relaxed font-light max-w-2xl mx-auto">
              Inspirations, tendances et coulisses de l&apos;univers Harp.
              Découvrez nos articles et conseils mode.
            </p>
          </div>
        </div>
