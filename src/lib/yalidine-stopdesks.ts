...
export const YALIDINE_STOPDESKS: YalidineStopDesk[] = [
  ...
  { wilayaId: 50, wilayaName: "Bordj Badji Mokhtar", centersCount: 0 },
  { wilayaId: 51, wilayaName: "Ouled Djellal", centersCount: 1 },
  { wilayaId: 52, wilayaName: "Béni Abbès", centersCount: 0 },
  { wilayaId: 53, wilayaName: "In Salah", centersCount: 1 },
  { wilayaId: 54, wilayaName: "In Guezzam", centersCount: 0 },
  ...
  { wilayaId: 58, wilayaName: "El Meniaa", centersCount: 1 },
  { wilayaId: 59, wilayaName: "Aflou", centersCount: 0 },
  { wilayaId: 60, wilayaName: "Barika", centersCount: 0 },
  { wilayaId: 61, wilayaName: "Ksar Chellala", centersCount: 0 },
  { wilayaId: 62, wilayaName: "Messaad", centersCount: 0 },
  { wilayaId: 63, wilayaName: "Aïn Oussara", centersCount: 0 },
  { wilayaId: 64, wilayaName: "Bou Saâda", centersCount: 0 },
  { wilayaId: 65, wilayaName: "El Abiodh Sidi Cheikh", centersCount: 0 },
  { wilayaId: 66, wilayaName: "El Kantara", centersCount: 0 },
  { wilayaId: 67, wilayaName: "Bir El Ater", centersCount: 0 },
  { wilayaId: 68, wilayaName: "Ksar El Boukhari", centersCount: 0 },
  { wilayaId: 69, wilayaName: "El Aricha", centersCount: 0 },
];
