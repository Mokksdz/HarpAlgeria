export const translations = {
  fr: {
    ...
    "contact.hero.title": "Nous sommes à votre écoute.",
    "contact.hero.desc": "Une question, une suggestion ou simplement envie de dire bonjour ? Notre équipe est là pour vous accompagner.",
    "contact.hours.title": "Horaires Service Client",
    "contact.hours.sunThu": "Dimanche - Jeudi",
    "contact.hours.sat": "Samedi",
    "contact.hours.fri": "Vendredi",
    "contact.hours.closed": "Fermé",
    "contact.whatsapp.cta": "Discuter sur WhatsApp",
    "contact.form.sendMessage": "Envoyez-nous un message",
    "contact.form.sendMessageDesc": "Remplissez le formulaire ci-contre et nous vous répondrons dans les plus brefs délais. Vous pouvez également nous contacter directement sur WhatsApp pour une réponse immédiate.",
    "contact.form.successTitle": "Message envoyé !",
    "contact.form.successDesc": "Merci de nous avoir contactés. Nous reviendrons vers vous très vite.",
    ...
    "contact.form.subjectSelect": "Sélectionnez un sujet",
    "contact.form.subjectProduct": "Question produit",
    "contact.form.subjectOrder": "Suivi de commande",
    ...
    // Journal
    "journal.badge": "Le Journal",
    "journal.title": "Notre Journal",
    "journal.desc": "Inspirations, tendances et coulisses de l'univers Harp. Découvrez nos articles et conseils mode.",
    "journal.all": "Tous",
    "journal.style": "Style",
    "journal.lookbook": "Lookbook",
    "journal.tips": "Conseils",
    "journal.news": "Actualités",
    "journal.noArticles": "Aucun article pour le moment",
    "journal.noArticlesDesc": "Revenez bientôt pour découvrir nos prochains articles.",
    "journal.readArticle": "Lire l'article",
    "journal.read": "Lire",
    "journal.previous": "Précédent",
    "journal.next": "Suivant",
    "journal.by": "Par",
    "journal.views": "lectures",
    "journal.tags": "Tags :",
    "journal.share": "Partager :",
    "journal.shareOnFacebook": "Partager sur Facebook",
    "journal.shareOnTwitter": "Partager sur Twitter",
    "journal.shareOnWhatsApp": "Partager sur WhatsApp",
    "journal.backToJournal": "Retour au journal",
    "journal.relatedArticles": "Articles similaires",
  ...
  ar: {
    ...
    "contact.hero.title": "نحن هنا للإصغاء إليك.",
    "contact.hero.desc": "سؤال، اقتراح أو مجرد تحية؟ فريقنا هنا لمساعدتك.",
    "contact.hours.title": "ساعات خدمة العملاء",
    "contact.hours.sunThu": "الأحد - الخميس",
    "contact.hours.sat": "السبت",
    "contact.hours.fri": "الجمعة",
    "contact.hours.closed": "مغلق",
    "contact.whatsapp.cta": "الدردشة عبر واتساب",
    "contact.form.sendMessage": "أرسل لنا رسالة",
    "contact.form.sendMessageDesc": "املأ النموذج المقابل وسنرد عليك في أقرب وقت. يمكنك أيضاً التواصل معنا مباشرة عبر واتساب للرد الفوري.",
    "contact.form.successTitle": "تم إرسال الرسالة!",
    "contact.form.successDesc": "شكراً لتواصلك معنا. سنعود إليك قريباً جداً.",
    ...
    "contact.form.subjectSelect": "اختر موضوعاً",
    "contact.form.subjectProduct": "سؤال عن منتج",
    "contact.form.subjectOrder": "متابعة الطلب",
    "contact.form.subjectReturn": "إرجاع واستبدال",
    "contact.form.subjectPartnership": "شراكة",
    "contact.form.subjectOther": "آخر",
    "contact.form.messageLabel": "الرسالة",
    "contact.form.messagePlaceholder": "كيف يمكننا مساعدتك؟",
    "contact.form.send": "إرسال",

    // Journal
    "journal.badge": "المجلة",
    "journal.title": "مجلتنا",
    "journal.desc": "إلهام واتجاهات وكواليس عالم هارب. اكتشفي مقالاتنا ونصائح الموضة.",
    "journal.all": "الكل",
    "journal.style": "أناقة",
    "journal.lookbook": "لوك بوك",
    "journal.tips": "نصائح",
    "journal.news": "أخبار",
    "journal.noArticles": "لا توجد مقالات حالياً",
    "journal.noArticlesDesc": "عودي قريباً لاكتشاف مقالاتنا القادمة.",
    "journal.readArticle": "قراءة المقال",
    "journal.read": "قراءة",
    "journal.previous": "السابق",
    "journal.next": "التالي",
    "journal.by": "بقلم",
    "journal.views": "مشاهدة",
    "journal.tags": "الوسوم:",
    "journal.share": "مشاركة:",
    "journal.shareOnFacebook": "مشاركة على فيسبوك",
    "journal.shareOnTwitter": "مشاركة على تويتر",
    "journal.shareOnWhatsApp": "مشاركة على واتساب",
    "journal.backToJournal": "العودة للمجلة",
    "journal.relatedArticles": "مقالات مشابهة",
    "journal.home": "الرئيسية",
